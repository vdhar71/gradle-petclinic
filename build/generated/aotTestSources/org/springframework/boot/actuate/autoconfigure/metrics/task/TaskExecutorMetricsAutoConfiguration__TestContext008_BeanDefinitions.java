 ...
 */
public class TaskExecutorMetricsAutoConfiguration__TestContext008_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getTaskExecutorMetricsAutoConfigurationBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(TaskExecutorMetricsAutoConfiguration__TestContext008_Autowiring::apply);
