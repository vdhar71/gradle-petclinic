 ...
 */
public class WebMvcAutoConfiguration__TestContext008_BeanDefinitions {
  /**
  ...
  public static class EnableWebMvcConfiguration {
    ...
    public static BeanDefinition getEnableWebMvcConfigurationBeanDefinition() {
      ...
      instanceSupplier = instanceSupplier.andThen(WebMvcAutoConfiguration_EnableWebMvcConfiguration__TestContext008_Autowiring::apply);
    ...
    public static BeanDefinition getWelcomePageNotAcceptableHandlerMappingBeanDefinition() {
      Class<?> beanType = WelcomePageNotAcceptableHandlerMapping.class;
      RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
