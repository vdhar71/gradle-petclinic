 ...
 */
public class CrashControllerIntegrationTests__TestContext008_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new CrashControllerIntegrationTests__TestContext008_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new CrashControllerIntegrationTests__TestContext008_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
